...
//-----------------------------------------------------
/*
function method_child_register_pattern_categories() {
    register_block_pattern_category(
        'method-child-page-components',
        array( 'label' => __( 'Page Components', 'method-child' ) )
    );
}

add_action( 'init', 'method_child_register_pattern_categories' );
*/
...
add_filter( 'block_categories_all' , function( $categories ) {
    ...
    $new_category = array(
        'slug'  => 'method-child-blocks',
        'title' => 'Method Child Blocks'
    );
...
function method_child_block_assets() {
    if ( ! is_admin() ) {
        wp_enqueue_style( 'method-child-global', get_stylesheet_directory_uri() . '/assets/css/global.css', array('wp-block-library', 'wp-block-library-theme', 'global-styles'), THEME_VERSION );
    }
}
...
//-----------------------------------------------------
/*
function method_child_theme_button_styles( $styles ) {
    $theme_styles = array(
        '' => 'Default',
        'small' => 'Small',
        'large' => 'Large',
...
add_filter( 'method_block_theme_button_styles', 'method_child_theme_button_styles', 10, 1 );
*/
...
//-----------------------------------------------------
/*
function method_child_theme_button_styles_label( $styles ) {
    return 'Button Size';
}
add_filter( 'method_block_theme_button_styles_label', 'method_child_theme_button_styles_label', 10, 1 );
*/
...
//-----------------------------------------------------
/*
function method_child_theme_button_label_styles( $styles ) {
    $label_styles = array(
        '' => 'Default',
...
add_filter( 'method_block_theme_label_styles', 'method_child_theme_button_label_styles', 10, 1 );
*/
