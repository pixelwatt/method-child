...
function method_child_register_theme_options_metabox() {
	...
	$cmb_options = new_cmb2_box(
		array(
			...
			'title'        => __( '<span class="method-logo-wrap">&nbsp;</span><span class="visually-hidden">Method </span>Child Theme Settings | v' . THEME_VERSION, 'method-child' ),
			'object_types' => array( 'options-page' ),

			'option_key'      => 'method_child_options',
			...
			'menu_title'      => esc_html__( 'Theme Settings', 'method-child' ),
			'position'        => 3,
			'save_button'     => esc_html__( 'Update Settings', 'method-child' ),
	...
	$cmb_options->add_field(
		array(
			'name'     => __( '<span style="font-size: 1.25rem; font-weight: 800; line-height: 1; text-transform: none;">Some Section</span>', 'method-child' ),
			'id'       => 'misc_info',
			'type'     => 'title',
		)
	);
